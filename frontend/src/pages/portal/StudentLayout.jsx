...
import { 
  GraduationCap, FileText, Bell, LogOut, Menu, X, 
  Home, BookOpen, Calendar, CheckSquare
} from 'lucide-react';
import { toast } from 'sonner';

const navigation = [
  { name: 'Dashboard', href: '/portal/student', icon: Home },
  { name: 'My Application', href: '/portal/student/application', icon: FileText },
  { name: 'Documents', href: '/portal/student/documents', icon: BookOpen },
  { name: 'Timeline', href: '/portal/student/timeline', icon: Calendar },
...
export default function StudentLayout() {
  ...
  useEffect(() => {
    ...
    if (user && user.account_type !== 'student' && user.role !== 'admin') {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b px-4 py-3 flex items-center justify-between">
        ...
        <span className="font-semibold text-purple-900">Student Portal</span>
        <div className="w-10" />
      </div>
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b">
            <Link to="/" className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-purple-900 text-sm">Student Portal</p>
