...
// URL slug to industry key mapping
const slugToIndustry = {
  'construction': 'construction',
  'constructii': 'construction',
  'bauwesen': 'construction',
  'gradjevinarstvo': 'construction',
...
export default function IndustryPage() {
  ...
  // Map URL slug to industry key
  const industryKey = slugToIndustry[industry] || industry;
    ...
    return (
      <div className="min-h-screen flex items-center justify-center pt-32">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-navy-900 mb-4">Industrie negăsită</h1>
          <p className="text-gray-600 mb-4">Pagina căutată nu a fost găsită.</p>
          <Button asChild className="bg-coral hover:bg-red-600 text-white rounded-full">
