...
import { Search, ChevronLeft, ChevronRight, Eye, ArrowRight, Loader2, ExternalLink } from "lucide-react";
            ...
            {detailLoading ? (
              ...
              <div className="p-6">
                ...
                <div className="mt-6 text-right">
                  <Link href={`/admin/migration/${selected.id}`} className="inline-flex items-center gap-1 text-sm text-[#E8553E] hover:underline font-medium">
