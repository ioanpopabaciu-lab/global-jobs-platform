...
import { Search, ChevronLeft, ChevronRight, Eye, CheckCircle, XCircle, Loader2, Globe, ExternalLink } from "lucide-react";
            ...
            {detailLoading ? (
              ...
              <div className="p-6">
                ...
                <div className="mt-4 text-right">
                  <Link href={`/admin/agencies/${selected.id}`} className="inline-flex items-center gap-1 text-sm text-[#E8553E] hover:underline font-medium">
